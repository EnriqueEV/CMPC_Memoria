...
def main():
    split_df_path = 'data/processed/split_roles_asof_2025-01-01.csv'
    ...
    results = evaluate_combination(base_uv_df, resumen_df, split_df, k=-1, threshold=0.85,fecha_min='2025-06-01')
    user_results = {}
    ...
    df_result.to_csv(f'data/result/result_{dep_weight}_{fun_weight}_{rolLoc_weight}_{role_weight}_{-1}_thresh.csv', index=False)
